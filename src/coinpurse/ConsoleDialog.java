...
public class ConsoleDialog {
    ...
    public void depositDialog() {
    	...
    	if (inline.isEmpty()) {
    		System.out.print("Enter value of coin(s) to deposit on one line [eg:1 2 5 10  (coin), 100 500 1000 (BankNote)]: ");
